...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a   href="#" onclick="DeletePost('{{url('Facebook/Post-Delete',app_encrypt($post->id))}}')" style="float: right"><i data-feather="trash-2" style="zoom: 1.4; color: darkred"></i> Delete</a>
        <br>
        <br>
