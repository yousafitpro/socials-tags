    ...
    <div class="row justify-content-center no-gutters">
        <div class="col-lg-4 col-md-6 col-12 p-30 rounded10 b-2 b-dashed border-info">
            <div class="content-top-agile p-10">
                ...
                <h2 class="text-primary" style="color: {{$business->theme_color}} !important;">Email Verification </h2>
                <p class="text-black-50">Verification code has been Sent to Registered Mail</p>
            </div>
            <div class="">
                <form action="{{route('security.VerifyEmail2FACode')}}" method="post" class="web-form">
                    @csrf
